...
function fun1() {
  ...
  image.src =
    "https://images.firstpost.com/wp-content/uploads/fpranking/1664436049275.jpg?impolicy=website&width=640&height=362";
...
function fun2() {
  ...
  let image = document.createElement("img");
  image.src =
    "https://images.firstpost.com/wp-content/uploads/fpranking/1664446130153.jpg?impolicy=website&width=640&height=362";
  let subtitle = document.createElement("h1");
  subtitle.setAttribute("id", "sub_title");
  subtitle.innerText =
...
function fun3() {
  ...
  let image = document.createElement("img");
  image.src =
    "https://images.firstpost.com/wp-content/uploads/fpranking/1664450868900.jpg?impolicy=website&width=640&height=362";
  let subtitle = document.createElement("h1");
  subtitle.setAttribute("id", "sub_title");
...
let read = [
  {
    num: "1",
    title:
      "Mumbai: Model ends life by hanging herself in hotel room, 'suicide note' found",
  ...
  },
  {
    num: "2",
    title:
      "Centre upgrades Mukesh Ambani's security cover to Z plus after threat review",
  ...
  },
  {
    num: "4",
    title:
      "Rahul lacks 'systematic seriousness', he can leave meeting midway and go for jogging, says Himanta",
